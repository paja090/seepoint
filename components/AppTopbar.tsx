...
const pageTitles: Array<[string, string]> = [
  ...
  ['/clients', 'Klienti'],
  ['/offers', 'Nabídky'],
  ['/sales/crm', 'Klientské CRM'],
  ['/sales/new', 'Nový návrh kampaně'],
  ['/sales/planner', 'Plánovač kampaně'],
  ['/sales/pricing', 'Cenotvorba'],
  ['/sales/approval', 'Interní schválení'],
  ['/sales/feedback', 'Zpětná vazba klienta'],
  ['/sales/conversion', 'Převod na rezervace'],
  ['/sales/success', 'Kampaň vytvořena'],
