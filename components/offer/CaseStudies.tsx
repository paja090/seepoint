...
export function CaseStudies({ offer }: { offer: ProposalOffer }) {
  if (offer.caseStudies.length === 0) return null;
  return (
            ...
            <div className="flex flex-1 flex-col gap-4 p-5">
              ...
              <dl className="grid grid-cols-3 gap-2 border-t border-slate-100 pt-4">
                ...
                <div>
                  ...
                  <dd className="mt-0.5 text-sm font-semibold text-slate-900">—</dd>
                </div>
              </dl>
