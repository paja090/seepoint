...
import { formatCzk, formatCzkDecimal } from '@/lib/mock-offer-data';

export function PricingSummary({ offer }: { offer: MockOffer }) {
  return (
    <section aria-labelledby="pricing-heading" className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm lg:p-8">
      ...
      <p className="mt-4 text-xs leading-5 text-slate-400">
        Uvedené ceny jsou ilustrační a slouží pro účely návrhu. Finální kalkulace se může lišit dle dostupnosti ploch.
      </p>
    </section>
  );
}
