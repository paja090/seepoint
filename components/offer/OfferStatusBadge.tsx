...
import type { MockOfferStatus } from '@/lib/mock-offer-data';

const meta: Record<MockOfferStatus, { label: string; className: string; Icon: typeof Send }> = {
...
export function OfferStatusBadge({ status }: { status: MockOfferStatus }) {
