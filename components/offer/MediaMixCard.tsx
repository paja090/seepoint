...
import type { MockMediaType } from '@/lib/mock-offer-data';
import { TONE_CLASSES, formatCzk, formatNumber } from '@/lib/mock-offer-data';

export function MediaMixCard({ media, sharePercent }: { media: MockMediaType; sharePercent: number }) {
      ...
      <div className="flex flex-1 flex-col gap-4 p-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="rounded-xl bg-slate-50 p-3">
            ...
            <p className="mt-1 text-lg font-semibold text-slate-900">{formatNumber(media.estimatedReach)}+</p>
          </div>
        </div>
