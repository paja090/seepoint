          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 pt-2">
              <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 space-y-1">
                ...
                <p className="text-sm text-slate-300">Jasný výkaz výlepů a oprav na daný den</p>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 space-y-1">
                ...
                <p className="text-sm text-slate-300">1-kliková navigace přímo ke sloupu či nosiči</p>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 space-y-1">
                ...
                <p className="text-sm text-slate-300">Foto před a po instalaci s automatickou kompresí</p>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 space-y-1">
                ...
                <p className="text-sm text-slate-300">Funguje i v místech s slabým signálem</p>
              </div>
            </div>
          </div>
            ...
            <div className="relative w-full max-w-[340px] rounded-[44px] border-[8px] border-slate-800 bg-slate-950 p-4 shadow-2xl ring-1 ring-purple-900/50">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  <div>
                    <span className="text-xs font-mono text-purple-400 font-bold uppercase">Terénní výkaz #104</span>
                ...
                <div className="rounded-2xl border border-purple-800/80 bg-slate-900 p-4 space-y-3 shadow-lg">
                  ...
                  <div className="p-2.5 rounded-xl bg-slate-950 text-xs font-mono text-slate-200 flex items-center justify-between">
                    <span>GPS: 49.8355, 18.2835</span>
                    <span className="text-sky-400 font-bold flex items-center gap-1">
                      <Navigation className="w-3.5 h-3.5" /> Navigovat
                    </span>
                  </div>
                  ...
                  <button type="button" className="w-full py-3 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-black text-sm shadow-lg transition">
                    ✓ Dokončit práci & Odeslat
                  </button>
                </div>

                {/* Completed Task Card */}
                <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-3 flex items-center justify-between text-xs sm:text-sm opacity-90">
                  <div>
                    <strong className="text-slate-200 block text-sm">CLP 28. října / Pošta</strong>
                    <span className="text-xs text-slate-400">Fotografie nahrána v 10:14</span>
                  </div>
                  <span className="text-emerald-400 font-bold text-xs sm:text-sm">✓ Hotovo</span>
                </div>
              </div>
            </div>
          </div>
