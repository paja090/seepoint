          ...
          <div className="lg:col-span-5 rounded-3xl border border-purple-800/80 bg-slate-950 p-6 sm:p-8 space-y-6 shadow-2xl">
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 flex items-center justify-between">
                <div>
                  <span className="text-xs text-slate-400 font-medium block">Spravované nosiče</span>
              ...
              <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 flex items-center justify-between">
                <div>
                  <span className="text-xs text-slate-400 font-medium block">Dokončené realizace</span>
