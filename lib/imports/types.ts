...
> = {
  CARRIERS: [
    { field: 'carrierCode', label: 'Kód nosiče / Evidenční kód', description: 'Unikátní označení nosiče (např. BB-01, OC-123)', required: true },
    { field: 'name', label: 'Název / Umístění / Lokalita', description: 'Popisný název nosiče' },
    { field: 'city', label: 'Město / Obec', description: 'Název města', required: true },
    { field: 'address', label: 'Celá adresa / Umístění', description: 'Ulice a číslo popisné' },
    ...
    { field: 'carrierType', label: 'Typ média / Formát', description: 'Kategorie OOH média' },
    { field: 'dimensions', label: 'Rozměr plochy', description: 'Např. 5,1 × 2,4 m' },
    { field: 'lighting', label: 'Osvětlení (Ano / Ne)', description: 'Zda je plocha osvětlena' },
    { field: 'price', label: 'Měsíční ceníková cena (Kč)', description: 'Základní cena nájmu za měsíc' },
    ...
    { field: 'gpsCoordinates', label: 'GPS souřadnice (kombinované)', description: 'Společná buňka se souřadnicemi např. "49.83, 18.29"' },
    ...
    { field: 'note', label: 'Poznámka k nosiči / ploše', description: 'Interní poznámka k nosiči' },
  ],
  SURFACES: [
    { field: 'carrierCode', label: 'Kód nosiče / Evidenční kód', description: 'Vazba na nadřazený nosič', required: true },
    ...
    { field: 'type', label: 'Typ nosiče / Média', description: 'Kategorie OOH' },
    { field: 'sidePosition', label: 'Pozice / Strana', description: 'A, B, 1, 2' },
    { field: 'dimensions', label: 'Rozměry', description: 'Šířka × výška (např. 5,1 × 2,4 m)' },
    { field: 'size', label: 'Rozměry (velikost)', description: 'Šířka × výška' },
    { field: 'lighting', label: 'Osvětlení (Ano / Ne)', description: 'Zda je plocha osvětlena' },
    { field: 'price', label: 'Cena nájmu (Kč)', description: 'Měsíční cena za plochu' },
    { field: 'city', label: 'Město / Obec', description: 'Město' },
    { field: 'address', label: 'Adresa / Umístění', description: 'Adresa nosiče' },
    { field: 'gpsCoordinates', label: 'GPS souřadnice', description: 'Kombinované souřadnice' },
  ...
  CLIENTS: [
    ...
    { field: 'clientName', label: 'Název inzerenta', description: 'Inzerující firma' },
    ...
    { field: 'city', label: 'Město', description: 'Město / Sídlo firmy' },
    ...
    { field: 'note', label: 'Poznámka', description: 'Poznámka ke klientovi' },
  ],
  OCCUPANCY: [
    { field: 'carrierCode', label: 'Kód nosiče / Plochy', description: 'Identifikátor obsazené plochy', required: true },
    { field: 'clientName', label: 'Název klienta / Inzerent', description: 'Inzerující firma' },
  ...
  PRICES: [
    { field: 'name', label: 'Název položky ceníku / Formát', description: 'Označení reklamního balíčku nebo formátu', required: true },
    { field: 'code', label: 'Kód formátu', description: 'Identifikátor ceníkové položky' },
    { field: 'carrierType', label: 'Typ nosiče / Formát', description: 'Kategorie nosiče' },
    { field: 'mediaType', label: 'Typ média', description: 'Kategorie plochy' },
    { field: 'rentalPrice', label: 'Základní cena nájmu (Kč)', description: 'Měsíční nájemné bez DPH', required: true },
    { field: 'productionPrice', label: 'Cena výroby / instalace / výlepu (Kč)', description: 'Jednorázový poplatek za instalaci či tisk' },
    { field: 'printPrice', label: 'Cena tisku (Kč)', description: 'Tisk plakátu / banneru' },
