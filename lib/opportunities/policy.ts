...
export function parseOpportunityCreateInput(raw: unknown): CreateOpportunityInput {
  ...
  return {
    ...
    evidenceFact: clean(body.evidenceFact, 'Ověřený fakt', 4_000),
    aiInterpretation: clean(body.aiInterpretation, 'AI interpretace', 4_000),
    aiRecommendation: clean(body.aiRecommendation, 'Doporučený postup', 4_000),
