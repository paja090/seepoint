...
export async function PATCH(request: Request) {
  ...
  const input = await request.json().catch(() => null) as { action?: string; firstName?: string; lastName?: string; phone?: string; currentPassword?: string; newPassword?: string } | null;
