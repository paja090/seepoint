  ...
  return (
    <AppShell>
      ...
      <section className="card overflow-x-auto">
        ...
        {employees.length === 0 ? <div className="rounded-lg bg-slate-50 p-4 text-sm text-slate-600"><p className="font-semibold text-slate-900">Zatím není evidovaný žádný zaměstnanec.</p><p className="mt-1">Založte první profil výše. Pokud bude jméno stejné jako pracovník v plánu práce, nové nebo znovu uložené zakázky se na něj automaticky spárují.</p></div> : (
